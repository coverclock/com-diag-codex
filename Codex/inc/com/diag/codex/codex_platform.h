...
#   define COM_DIAG_CODEX_PLATFORM_OPENSSL_1_1_1 1
#elif defined(OPENSSL_VERSION_NUMBER) && (OPENSSL_VERSION_NUMBER == 0x101010ef) && !defined(OPENSSL_IS_BORINGSSL)
#   define COM_DIAG_CODEX_PLATFORM "OpenSSL 1.1.1n"
#   define COM_DIAG_CODEX_PLATFORM_OPENSSL 0x101010ef
#   define COM_DIAG_CODEX_PLATFORM_OPENSSL_1_1_1 1
#elif defined(OPENSSL_VERSION_NUMBER) && (OPENSSL_VERSION_NUMBER == 0x30000020) && !defined(OPENSSL_IS_BORINGSSL)
