...
#include "com/diag/codex/codex_release.h"

const char COM_DIAG_CODEX_RELEASE_KEYWORD[] = "COM_DIAG_CODEX_RELEASE=" COM_DIAG_CODEX_RELEASE;
const char * COM_DIAG_CODEX_RELEASE_VALUE = &COM_DIAG_CODEX_RELEASE_KEYWORD[sizeof("COM_DIAG_CODEX_RELEASE=") - 1];
